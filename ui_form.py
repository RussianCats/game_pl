...
class Ui_Game(object):
    def setupUi(self, Game):
        ...
        self.pushButton_U = QPushButton(self.widget)
        ...
        self.pushButton_O = QPushButton(self.widget)
        ...
        self.pushButton_I = QPushButton(self.widget)
        ...
        self.pushButton_semicolon.setObjectName(u"pushButton_semicolon")
        ...
        self.pushButton_J = QPushButton(self.widget_2)
        ...
        self.pushButton_H = QPushButton(self.widget_2)
        ...
        self.pushButton_L = QPushButton(self.widget_2)
        ...
        self.pushButton_S = QPushButton(self.widget_2)
        ...
        self.pushButton_comma = QPushButton(self.widget_2)
        ...
        self.pushButton_G = QPushButton(self.widget_2)
        ...
        self.pushButton_K = QPushButton(self.widget_2)
        ...
        self.pushButton_A = QPushButton(self.widget_2)
        ...
        self.pushButton_V = QPushButton(self.widget_3)
        ...
        self.pushButton_N = QPushButton(self.widget_3)
        ...
        self.pushButton_M = QPushButton(self.widget_3)
        ...
        self.pushButton_Z = QPushButton(self.widget_3)
        ...
        self.pushButton_comma1 = QPushButton(self.widget_3)
        self.pushButton_comma1.setObjectName(u"pushButton_comma1")
        ...
        self.pushButton_Shift = QPushButton(self.widget_3)
...
"QLabel { background-color : white; color : black; }")
    ...
    def retranslateUi(self, Game):
        ...
        self.pushButton_O.setText(QCoreApplication.translate("Game", u"O", None))
        self.pushButton_I.setText(QCoreApplication.translate("Game", u"I", None))
#if QT_CONFIG(tooltip)
        self.pushButton_Q.setToolTip(QCoreApplication.translate("Game", u"<html><head/><body><pre style=\"-qt-paragraph-type:empty; margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; font-family:'monospace';\"><br/></pre></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.pushButton_Q.setWhatsThis(QCoreApplication.translate("Game", u"<html><head/><body><pre style=\"-qt-paragraph-type:empty; margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; font-family:'monospace';\"><br/></pre></body></html>", None))
...
":", None))
        ...
        self.pushButton_H.setText(QCoreApplication.translate("Game", u"H", None))
        self.pushButton_L.setText(QCoreApplication.translate("Game", u"L", None))
        self.pushButton_S.setText(QCoreApplication.translate("Game", u"S", None))
        self.pushButton_comma.setText(QCoreApplication.translate("Game", u"'\n"
"\"", None))
        self.pushButton_44.setText(QCoreApplication.translate("Game", u"\\\n"
"|", None))
        self.pushButton_D.setText(QCoreApplication.translate("Game", u"D", None))
        self.pushButton_G.setText(QCoreApplication.translate("Game", u"G", None))
        self.pushButton_K.setText(QCoreApplication.translate("Game", u"K", None))
        self.pushButton_A.setText(QCoreApplication.translate("Game", u"A", None))
        ...
        self.pushButton_B.setText(QCoreApplication.translate("Game", u"B", None))
        self.pushButton_V.setText(QCoreApplication.translate("Game", u"V", None))
        self.pushButton_C.setText(QCoreApplication.translate("Game", u"C", None))
        self.pushButton_N.setText(QCoreApplication.translate("Game", u"N", None))
        self.pushButton_M.setText(QCoreApplication.translate("Game", u"M", None))
        self.pushButton_50.setText("")
        self.pushButton_Z.setText(QCoreApplication.translate("Game", u"Z", None))
...
">", None))
        ...
        self.label_3.setText(QCoreApplication.translate("Game", u"TIME:", None))
